...
$app->router->group([
    ...
    require __DIR__.'/../routes/api/v1/schedule_test.php';
    require __DIR__.'/../routes/api/v1/room.php';
    require __DIR__.'/../routes/api/v1/classroom.php';
    ...
    require __DIR__.'/../routes/api/v1/ticket.php';
});
